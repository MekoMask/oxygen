...
public class ElectrolysisCategory extends CreateRecipeCategory<ElectrolysisRecipe>  {
	...
	static {
		RECIPES.add(ElectrolysisRecipe.create(FluidIngredient.fromFluid(Fluids.WATER, 10), new FluidStack(NorthstarFluids.OXYGEN.get().getSource(), 7), new FluidStack(NorthstarFluids.OXYGEN.get().getSource(), 2), "water_electrolysis"));
	}
